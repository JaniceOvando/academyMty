...
public class Principal {
	public static void main(String[] args) {
		...
		System.out.println("V5 Comparator Functional");
		...
		Comparator<Empleado> comparator = Comparator.<Empleado>comparingDouble(x -> x.getSueldo())
											.thenComparingInt(z -> z.getEdad())
											.thenComparing(pato -> pato.getNombre())
											.reversed();
